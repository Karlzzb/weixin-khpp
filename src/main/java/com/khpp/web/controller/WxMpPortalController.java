...
public class WxMpPortalController extends GenericController {
	@Autowired
	private WxGenricService wxService;
	...
	public String post(
		...
		if (encType == null) {
			...
			WxMpXmlMessage inMessage = WxMpXmlMessage.fromEncryptedXml(
					requestBody, this.getWxService().getWxMpConfigStorage(),
			...
			out = outMessage.toEncryptedXml(this.getWxService()
	...
	protected WxGenricService getWxService() {
